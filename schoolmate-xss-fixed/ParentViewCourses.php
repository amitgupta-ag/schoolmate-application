<?php
  ...
  $_POST['student'] = intval($_POST['student']);

 $query = mysql_query("SELECT studentid, fname, lname FROM students WHERE studentid = $_POST[student]")
   or die("ParentViewCourses.php: Unable to get the studentid $_POST[student] - ".mysql_error());
