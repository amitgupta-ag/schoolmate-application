<?php
 ...
 $schoolname = htmlentities($schoolname);
 ...
 $address = htmlentities(mysql_result($query,0));
 ...
 $phone = htmlentities(mysql_result($query,0));
 ...
 $temp        = htmlentities(mysql_fetch_row($query));
 $sitetext    = $temp[0];
 $sitemessage = $temp[1];
 // End GET queries
