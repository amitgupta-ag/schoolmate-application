 ...
 *
 */
 public class Test_Add_User_18 extends Globals{
	
	WebTester tester;
	
	public String subject = "Users";	
	public String pageName = "Add New User";	
	public String form = "users";	
	public String page = "1";	
	public String page2 = "14";	
