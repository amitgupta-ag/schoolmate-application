 ...
 *
 */
 public class Test_Add_Parent_93  extends Globals {
	
	WebTester tester;
	
	public String subject = "Parents";	
	public String pageName = "Add New Parent";	
	public String form = "parents";	
	public String page = "1";	
	public String page2 = "23";	
