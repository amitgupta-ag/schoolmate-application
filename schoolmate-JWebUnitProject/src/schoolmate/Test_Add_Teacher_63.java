 ...
 *
 */
 public class Test_Add_Teacher_63  extends Globals {
	
	WebTester tester;
	
	public String subject = "Teachers";	
	public String pageName = "Add New Teacher";	
	public String form = "teachers";	
	public String page = "1";	
	public String page2 = "16";	
