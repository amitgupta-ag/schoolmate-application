 ...
 *
 */
 public class Test_Edit_Parent_161  extends Globals {
	...
	public void page(){
		...
		tester.clickLinkWithText("Parent");
		
		tester.assertMatch("Manage Parent");
		
		tester.setWorkingForm("parents");
		tester.checkCheckbox("delete[]");
		
		tester.setTextField("page", "1 '> <a href=\"hacker.it\">malicious link page</a><br '");
		tester.setTextField("page2", "24 '> <a href=\"hacker.it\">malicious link page2</a><br '");
