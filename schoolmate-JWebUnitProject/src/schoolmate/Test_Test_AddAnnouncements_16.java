 ...
 *
 */
 public class Test_Test_AddAnnouncements_16  extends Globals {

	WebTester tester;

	public String subject = "Announcements";
	public String pageName = "Add New Announcement";
	public String form = "announcements";
	public String page = "1";
	public String page2 = "18";
